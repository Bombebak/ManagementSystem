...
namespace ManagementSystem.Api.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            SignInManager<ManagementSystem.Api.Data.Entities.ApplicationUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ManagementSystem.Api.Data.Entities.ApplicationUser { UserName = Input.Email, Email = Input.Email };
